...
const categories = ["All", "Full-Stack Web Development", "Frontend Engineering", "Data Science", "Cybersecurity", "Product Design/ UI/UX"];
...
const allCourses = [
  ...
  },
  {
    ...
    description: "Build cross-platform products design for iOS and Android.",
  },
  {
    id: 3,
  ...
  },
  {
    ...
    description: "Master java, Redux, and modern frontend engineering practices.",
  },
];
